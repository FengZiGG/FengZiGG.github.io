...
!function(e) {
  ...
  if (!e.jQuery) {
    ...
    $.isArray = Array.isArray || function(e) { return "array" === $.type(e) },
    $.isPlainObject = function(e) {
      ...
      var e, t, r, a, n, o, i = arguments[0] || {}, s = 1, l = arguments.length,
                            u = !1;
      ...
      position : function() {
        function e() {
          for (var e = this.offsetParent || document;
               e && "html" === !e.nodeType.toLowerCase &&
               "static" === e.style.position;)
            e = e.offsetParent;
          return e || document
        }
        var t = this[0], e = e.apply(t), r = this.offset(),
            a = /^(?:body|html)$/i.test(e.nodeName) ? {top : 0, left : 0}
                                                    : $(e).offset();
    ...
    for (var a = {}, n = a.hasOwnProperty, o = a.toString,
             i = "Boolean Number String Function Array Date RegExp Object Error"
                     .split(" "),
             s = 0;
         s < i.length; s++)
    ...
    function(e) {
      ...
      return function(e, t, r, a) {
        ...
        function l(e, r, a, n) {
          ...
          for (var P = 0; 4 > P; ++P)
            if ("number" != typeof arguments[P] || isNaN(arguments[P]) ||
              ...
              return !1;
          e = Math.min(e, 1), a = Math.min(a, 1), e = Math.max(e, 0),
          a = Math.max(a, 0);
        ...
        function u(e, t) {
          var r = e;
          return g.isString(e) ? v.Easings[e] || (r = !1)
                               : r = g.isArray(e) && 1 === e.length
                                         ...
                                         : g.isArray(e) && 2 === e.length
                                               ...
                                               : g.isArray(e) && 4 === e.length
                                                     ? l.apply(null, e)
                                                     : !1,
                                 r === !1 && (r = v.Easings[v.defaults.easing]
                                                      ? v.defaults.easing
                                                      : h),
                                 r
        }
        function c(e) {
          if (e) {
            ...
            for (var o = 0; r > o; o++)
              if (v.State.calls[o]) {
                var s = v.State.calls[o], l = s[0], u = s[2], f = s[3], d = !!f,
                    m = null;
                f || (f = v.State.calls[o][3] = t - 16);
                for (var y = Math.min((t - f) / u.duration, 1), h = 0,
                         b = l.length;
                     b > h; h++) {
                  ...
                  if (i(w)) {
                    ...
                    if (u.display !== a && null !== u.display &&
                      ...
                      if ("flex" === u.display) {
                        ...
                        $.each(
                            C,
                            function(e,
                                     t) { x.setPropertyValue(w, "display", t) })
                      }
                    ...
                    for (var T in S)
                      if ("element" !== T) {
                        var k = S[T], A,
                            F = g.isString(k.easing) ? v.Easings[k.easing]
                                                     : k.easing;
                        if (1 === y)
                          A = k.endValue;
                        else {
                ...
                u.display !== a && "none" !== u.display &&
                    ...
                    u.progress &&
                        u.progress.call(s[1], s[1], y,
                                        Math.max(0, f + u.duration - t), f, m),
                    1 === y && p(o)
              }
          }
        ...
        function p(e, t) {
          if (!v.State.calls[e])
            return !1;
          for (var r = v.State.calls[e][0], n = v.State.calls[e][1],
                   o = v.State.calls[e][2], s = v.State.calls[e][4], l = !1,
                   u = 0, c = r.length;
               c > u; u++) {
            var p = r[u].element;
            if (t || o.loop ||
              ...
              $.each(x.Lists.transforms3D,
                  ...
                  o.mobileHA &&
                      (f = !0, delete i(p).transformCache.translate3d),
            ...
            d =
              ...
              return t.webkitRequestAnimationFrame ||
                     t.mozRequestAnimationFrame || function(t) {
                       ...
                       return a = Math.max(0, 16 - (r - e)), e = r + a,
                              setTimeout(function() { t(r + a) }, a)
                     }
            }(),
            g = {
              ...
              isSVG : function(
                  e) { return t.SVGElement && e instanceof t.SVGElement },
        ...
        var b = function() {
          ...
          return function a(e, t, n) {
            ...
            for (e = parseFloat(e) || 500, t = parseFloat(t) || 20,
                n = n || null, o.tension = e, o.friction = t, c = null !== n,
                c ? (s = a(e, t), p = s / n * u) : p = u;
                 ;)
              if (f = r(f || o, p), i.push(1 + f.x), s += 16,
        ...
        v.Easings = {
          ...
          spring : function(
              e) { return 1 - Math.cos(4.5 * e * Math.PI) * Math.exp(6 * -e) }
        },
        $.each(
            [
              [ "ease", [ .25, .1, .25, 1 ] ],
        ...
        var x = v.CSS = {
          ...
          Lists : {
            colors : [
              "fill", "stroke", "stopColor", "color", "backgroundColor",
              "borderColor", "borderTopColor", "borderRightColor",
              "borderBottomColor", "borderLeftColor", "outlineColor"
            ],
            transformsBase : [
              "translateX", "translateY", "scale", "scaleX", "scaleY", "skewX",
              "skewY", "rotateZ"
            ],
            transforms3D : [
              "transformPerspective", "translateZ", "scaleZ", "rotateX",
              "rotateY"
            ]
          },
          Hooks : {
            ...
            injectValue : function(e, t, r) {
              ...
              if (a) {
                ...
                return r = x.Hooks.cleanRootPropertyValue(n, r),
                       i = r.toString().match(x.RegEx.valueSplit), i[o] = t,
                       s = i.join(" ")
              }
              return r
            }
            ...
            function s(e, r) {
              ...
              if (8 >= f)
                ...
                if (/^(width|height)$/.test(r) &&
                        ...
                        (u = !0, x.setPropertyValue(
                                     e, "display", x.Values.getDisplayType(e))),
                    !o) {
                  if ("height" === r &&
                      "border-box" !== x.getPropertyValue(e, "boxSizing")
                                           .toString()
                                           .toLowerCase()) {
                    var c =
                        e.offsetHeight -
            ...
            if (x.Hooks.registered[r]) {
              ...
              "transform" !== p &&
                  (d = s(e, x.Names.prefixCheck(p)[0]),
                   x.Values.isCSSNullValue(d) && x.Hooks.templates[r] &&
        ...
        x.Hooks.register(), x.Normalizations.register(),
        ...
        var S = function() {
          ...
          function n() {
            function e(e) {
              ...
              function d() {
                ...
                N.lastParent = e.myParent, N.lastPosition = e.position,
                ...
                if (o && a)
                  ...
                  v.init(u), e.myParent.appendChild(u),
                      $.each(
                          ...
                          function(
                              e, t) { v.CSS.setPropertyValue(u, t, "hidden") }),
                      ...
                      $.each(
                          ...
                          function(
                              e, t) { v.CSS.setPropertyValue(u, t, s + "%") }),
                      v.CSS.setPropertyValue(u, "paddingLeft", s + "em"),
                      l.percentToPxWidth = N.lastPercentToPxWidth =
                          (parseFloat(
                               x.getPropertyValue(u, "width", null, !0)) ||
                           1) /
                          s,
                      l.percentToPxHeight = N.lastPercentToPxHeight =
                          (parseFloat(
                ...
                return null === N.remToPx &&
                           (N.remToPx = parseFloat(x.getPropertyValue(
                                            r.body, "fontSize")) ||
                                        16),
                       null === N.vwToPx &&
                           (N.vwToPx = parseFloat(t.innerWidth) / 100,
                            N.vhToPx = parseFloat(t.innerHeight) / 100),
                       l.remToPx = N.remToPx, l.vwToPx = N.vwToPx,
                       l.vhToPx = N.vhToPx,
                       v.debug >= 1 &&
              ...
              if ("scroll" === k) {
                ...
                o.container
                    ...
                    : (C = v.State.scrollAnchor[v.State["scrollProperty" + S]],
                       A = v.State.scrollAnchor
                               [v.State["scrollProperty" +
                                        ("Left" === S ? "Top" : "Left")]],
                       F = $(n).offset()[S.toLowerCase()] + V),
                            ...
                            v.debug && console.log("tweensContainer (scroll): ",
                                                   s.scroll, n)
              } else if ("reverse" === k) {
                ...
                "none" === i(n).opts.display && (i(n).opts.display = "auto"),
                    ...
                    i(n).opts.loop = !1, i(n).opts.begin = null,
                    i(n).opts.complete = null, b.easing || delete o.easing,
                      ...
                      if (RegExp("^" + x.Lists.colors.join("$|^") + "$")
                        ...
                        if (x.RegEx.isHex.test(n)) {
                          for (var s = [ "Red", "Green", "Blue" ],
                                   ...
                                   u = i ? x.Values.hexToRgb(i) : a, c = 0;
                               c < s.length; c++) {
                            var f = [ l[c] ];
                            o && f.push(o), u !== a && f.push(u[c]),
                                h[e + s[c]] = f
                          }
                          delete h[e]
                        }
            ...
            v.mock !== !1 &&
                ...
                o.visibility !== a && null !== o.visibility &&
          ...
          if (g.isWrapped(this)
                  ...
                  : (l = !0, d = 1,
                     m = s ? arguments[0].elements || arguments[0].e
                           : arguments[0]),
              m = o(m)) {
            ...
            l && v.Promise &&
                (T.promise = new v.Promise(function(
                     e, t) { T.resolver = e, T.rejecter = t }));
            var k;
            switch (h) {
            case "scroll":
              k = "scroll";
                           ...
                           parseFloat(F.stagger)
                               ...
                               : g.isFunction(F.stagger) &&
                                 ...
                                 F.drag &&
                                     (F.duration =
                                          parseFloat(E) ||
                                          (/^(callout|transition)/.test(h) ? 1e3
                                                                           : y),
                                      F.duration = Math.max(
                                          F.duration * (F.backwards
                                                            ? 1 - e / P
                                                            : (e + 1) / P),
                                          .75 * F.duration, 200)),
                                 v.Redirects[h].call(t, t, F || {}, e, P, m,
                                                     T.promise ? T : a)
                         }), e()
                }
                var H =
                    "Velocity: First argument (" + h +
            ...
            if (F.loop = parseInt(F.loop), R = 2 * F.loop - 1, F.loop)
              for (var O = 0; R > O; O++) {
                ...
                O === R - 1 &&
                    (z.display = F.display, z.visibility = F.visibility,
        ...
        return v.State.isMobile || r.hidden === a ||
               ...
               e.Velocity = v,
               e !== t &&
                   (e.fn.velocity = S, e.fn.velocity.defaults = v.defaults),
               $.each([ "Down", "Up" ], function(e, t) {
                 ...
                 v.Redirects["fade" + t] = function(e, r, n, o, i, s) {
                   ...
                   l.complete =
                       n !== o - 1
                           ? l.begin = null
                           : function() { c && c.call(i, i), s && s.resolver(i) },
                   l.display === a &&
