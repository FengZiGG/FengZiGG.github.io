...
document.addEventListener('DOMContentLoaded', () => {
  ...
  var sidebarToggleMotion = {
    ...
    init : function() {
      ...
      document.querySelector('#sidebar-dimmer')
    ...
    showSidebar : function() {
      ...
      if (typeof Velocity === 'function') {
        Velocity(document.querySelectorAll('.sidebar .motion-element'),
  ...
  function updateFooterPosition() {
    ...
    var containerHeight = document.querySelector('.header').offsetHeight +
